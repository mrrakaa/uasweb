...
if (isset($_POST['sign-up'])) {
    $email = $_POST['email-registrasi'];
    $username = $_POST['username-registrasi'];
    $password = $_POST['password-registrasi'];
    ...
    if ($password !== $confirmPassword) {
        ...
        $checkQuery = "SELECT * FROM t_input WHERE email='$email'";
...
if (isset($_POST['login'])) {
    $emailOrUsername = $_POST['user-email'];
    $password = $_POST['password-login'];

    // Periksa apakah pengguna menggunakan email atau username
    if (filter_var($emailOrUsername, FILTER_VALIDATE_EMAIL)) {
        // Menggunakan email
        $query = "SELECT * FROM t_input WHERE email='$emailOrUsername' AND password='$password'";
    } else {
        // Menggunakan username
        $query = "SELECT * FROM t_input WHERE username='$emailOrUsername' AND password='$password'";
    }
    ...
    if ($result->num_rows == 1) {
        ...
        $error = "Login gagal. Periksa kembali Nama dan Password Anda.";
    }
}
                    ...
                    <div class="col-sm-6 p-0">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <div class="sub-title">Registrasi untuk gunakan Uang - Ku</div>
                            </div>
                            ...
                            <div class="card-body">
                                <form method="POST">
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="email" name="email-registrasi" class="form-control"
                    ...
                    <div class="col-sm-6 p-0">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <div class="sub-title">Login untuk gunakan Uang - Ku</div>
                            </div>
                            <div class="icon-user">
                                <h4 class="fa fa-user"></h4>
                            </div>
