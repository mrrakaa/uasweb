...
<body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top main-nav" id="mainNav">
        <div class="container">
            <a class="js-scroll-trigger" href="#page-top">
                <img src="img/logo4.png" width="20px" style="margin-right: 10px; margin-bottom: 2px;">
            </a>
            <a class="navbar-brand js-scroll-trigger" href="#page-top">Uang - Ku</a>
    ...
    <header id="home" class="text-light parallax">
        <div class="container konten">
            <h1 style="font-size: 36pt;">Welcome to Uang - Ku</h1>
    ...
    <section id="features" class="bg-light">
        <div class=" container konten2">
            ...
            <div class="col-lg-12 foot-fitur">
                <h4 class="headline text-center">Uang - Ku</h4>
                <p class="isi-fitur text-center">Uang - Ku adalah aplikasi web pencatatan keuangan harian yang
        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-8 mx-auto">
              ...
              <div class="row text-center">
                <div class="col col1">
                  <a href="https://www.instagram.com/mrrakaa_/" target="_blank">
                ...
                <div class="col col3">
                  <a href="https://wa.me/6282272964295" target="_blank">
                    <img src="https://img.icons8.com/color/480/000000/whatsapp.png" width="70%">
                  </a>
                </div>
                <div class="col col4">
                  <a href="https://www.youtube.com" target="_blank">
                    <img src="https://img.icons8.com/color/480/000000/youtube-squared.png" width="70%">
                  </a>
                </div>
              </div>
            </div>
        ...
        <div class="container text-light">
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6 p-3">
                    <h5> <b>About</b> </h5>
                    <p class="mb-0">Aplikasi Uang - Ku dilengkapi dengan fitur menarik yang dapat mempermudah user mengelola keuangannya.</p>
                </div>
                <div class="col-lg-3 col-md-6 p-3">
                    <h5> <b>Follow us</b> </h5>
                    <div class="row">
                        <div class="col-md-12 d-flex align-items-center justify-content-between my-2">
                            <a href="https://www.instagram.com/mrrakaa_/" class="foot-link" target="_blank">
            ...
            <div class="row">
                <div class="col-md-12 text-center">
                    <span class="text">Created by Rakha 
                        <a href="https://www.instagram.com/mrrakaa_/">Musyaffa Rakha</a>
                      </span>                </div>
            </div>
        </div>
    </div>
