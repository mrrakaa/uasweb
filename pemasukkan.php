...
if (isset($_POST['submit'])) {
    ...
    $insertQuery = "INSERT INTO t_pemasukkan (tanggal, keterangan, sumber, jumlah) VALUES ('$tanggal', '$keterangan', '$sumber', '$jumlah')";
...
if (isset($_GET['hapus'])) {
    ...
    $deleteQuery = "DELETE FROM t_pemasukkan WHERE id = '$id'";
...
$query = "SELECT * FROM t_pemasukkan";
...
<head>
	...
	<title>Uang - Ku - Pemasukkan</title>
...
<div class="container" id="container">
    ...
    if ($result->num_rows > 0) {
        ...
        while ($row = $result->fetch_assoc()) {
            ...
            echo "<td>
                <a href='pemasukkan.php?hapus=" . $row['id'] . "' class='btn btn-danger btn-sm'>Hapus</a>
...
if (isset($_POST['submit'])) {
    ...
    $insertQuery = "INSERT INTO pemasukkan (tanggal, keterangan, sumber, jumlah, username) VALUES ('$tanggal', '$keterangan', '$sumber', '$jumlah', '$username')";
